...
class GradCacheTrainer(Trainer):
    def __init__(self, dynamo_plugin=None, *args, **kwargs):
        self.dynamo_plugin = dynamo_plugin
        super().__init__(*args, **kwargs)
    
    def create_accelerator_and_postprocess(self):
        """Override to include TorchDynamoPlugin if provided."""
        ...
        #@lucaswychan Add TorchDynamoPlugin if provided
        if self.dynamo_plugin is not None:
            args["dynamo_plugin"] = self.dynamo_plugin
    ...
    #                        import pdb; pdb.set_trace()
                    ...
                    if do_sync_step:
                        ...
                        #@lucaswychan this is a hack to get the learning rate before the optimizer step (not self.get_learning_rates)
