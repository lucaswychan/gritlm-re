...
def eager_attention_forward(
    ...
    **kwargs: Unpack[TransformersKwargs],
    ...
    # @lucaswychan we only add the causal mask if the attention mask is not None and is_causal is True
...
class Qwen2Attention(nn.Module):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        # @lucaswychan update self.is_causal as flash_attention_forward determine the causality based on self.is_causal instead of the is_causal passed in
